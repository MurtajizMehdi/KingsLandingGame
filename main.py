...
def GameQuestionOne():
    ...
    if answer == 1:
        ...
        print('The "knight" was actually a deranged imposter who ambushed a REAL knight.')
...
def GameQuestionTwo():
    ...
    answer = int(input(
        'You see a bridge that leads to the other side. Do you... 1) take the bridge, or 2) slide down the mountain and go through the ravine: '))
    if answer == 1:
        print("The bridge's ropes give out, and the bridge collapses!")
        PlayerDied()
    elif answer == 2:
        print('You notice the ropes at the other side were very flimsy, you made the right call.')
    else:
        print('Please choose "1" or "2".')
        GameQuestionTwo()
...
def GameQuestionThree():
    ...
    if answer == 1:
        ...
        print('You notice that after a while of walking, the rock disappears without a trace...')
    else:
        print('Please choose "1" or "2".')
        GameQuestionThree()
...
def GameQuestionFour():
    ...
    print(
        'The king notices your scars and injuries and approaches you and honors your bravery and courage, he praises you...')
    print('He offers you the divine right to rule with him...')
    answer = int(input(
        'Do you... 1) reject the offer and try to assassinate the king for his crimes against your people, or 2) take it and join the king: '))
    if answer == 1:
        print(
            'The king stops you in your tracks with his mighty strength, and proceeds to take you in to his castle with your hands tied up.')
    elif answer == 2:
        ...
        print(
            'The son has been following you all along! He runs up behind you and impales you so the King will have no choice but to let him rule')
        PlayerDied()
    else:
        print('Please choose "1" or "2".')
        GameQuestionFour()
...
def GameQuestionFive():
    ...
    answer = input(
        'He cuts the ropes off your hands, and reaches out to shake them, do you... 1) Shake them and accept the offer, or 2) slap his hand away.')
    if answer == 1:
        print(
            'You two bring peace to your land as you co-rule with the king. Your people are suffering no longer. Rejoice!')
    elif answer == 2:
...
def TitleScreen():
    ...
    if Tschoice == 1:
        print('You are a peasant boy who comes from a very poor village...')
